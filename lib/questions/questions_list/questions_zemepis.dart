...
List<Question> questionsZemepis = [
  Question(
      '1. Juvenilná voda je:',
      '/',
      [
  ...
  Question(
      ...
      0),
  Question(
      '8. Voda v tekutom stave pokrýva zemský povrch v množstve okolo:',
      '/',
      [
        'a/ 90%',
        'b/ 75%',
  ...
  Question(
      ...
      '/',
      [
        'a/ Nemecko, Rakúsko, Slovensko, Maďarsko, Chorvátsko, Srbsko, Rumunsko, Bulharsko, Moldavsko, Ukrajina',
  ...
  Question(
      ...
      2),
  Question(
      '20. Dunaj podľa dĺžky v Európe je rieka:',
      '/',
      [
        'a/ prvá najdlhšia',
        'b/ druhá najdlhšia',
      ...
      1),
  Question(
      '21. Do povodia Dunaja nepatrí rieka:',
      '/',
      [
        'a/ Váh',
        'b/ Bodrog',
  ...
  Question(
      ...
      1),
  Question(
      '45. GPS je prístroj na určovanie polohy plavidla na princípe:',
      '/',
      [
        'a/ nebeských telies',
        'b/ satelitov',
  ...
  Question(
      ...
      0),
  Question(
      '56. Poškodenie CASCO (kasko) znamená poškodenie:',
      '/',
      [
        'a/ plavidla aj tovaru',
        'b/ tovaru a osôb',
        'c/ plavidla',
      ],
      2),
  ...
  Question(
      ...
      [
        ...
        'b/ poludník',
        'c/ uhol medzi rovníkom a príslušnou polohou určitého bodu na severnej alebo južnej pologuli (0°- 90°)',
      ],
      2),
  Question(
  ...
  Question(
      ...
      '/',
      [
        'a/ víchor, prejavujúci sa vírom točiacim sa proti smeru hodinových ručičiek, vznikajúci v extrémne nízkom barometrickom tlaku, postupuje spravidla severovýchodným smerom - veľmi nebezpečný pre plavidlá',
        'b/ víchor, prejavujúci sa vírom točiacim sa v smere hodinových ručičiek, vznikajúci v extrémne nízkom barometrickom tlaku, postupuje spravidla juhovýchodným smerom - veľmi nebezpečný pre plavidlá',
